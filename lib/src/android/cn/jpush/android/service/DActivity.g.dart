...
class cn_jpush_android_service_DActivity extends android_app_Activity  {
  ...
  static Future<cn_jpush_android_service_DActivity> create__() async {
    final __result__ = await kJcoreFluttifyChannel.invokeMethod(
      'ObjectFactory::createcn_jpush_android_service_DActivity__',
    
    );
    return JcoreFluttifyAndroidAs<cn_jpush_android_service_DActivity>(__result__);
  }
  ...
  static Future<List<cn_jpush_android_service_DActivity>> create_batch__(int length) async {
    ...
    final __result_batch__ = await  kJcoreFluttifyChannel.invokeListMethod(
      'ObjectFactory::create_batchcn_jpush_android_service_DActivity__',
      {'length': length}
    );
    return __result_batch__
        .map((it) => JcoreFluttifyAndroidAs<cn_jpush_android_service_DActivity>(it))
        .toList();
  }
  ...
  @override
  String toString() {
    return 'cn_jpush_android_service_DActivity{refId: $refId, runtimeType: $runtimeType, tag__: $tag__}';
  }
}
