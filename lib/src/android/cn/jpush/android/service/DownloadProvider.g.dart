...
class cn_jpush_android_service_DownloadProvider extends android_content_ContentProvider  {
  ...
  Future<bool> onCreate() async {
    ...
    final __result__ = await MethodChannel('me.yohom/jcore_fluttify').invokeMethod('cn.jpush.android.service.DownloadProvider::onCreate', {"refId": refId});
  ...
  Future<android_os_Bundle> call(String var1, String var2, android_os_Bundle var3) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/jcore_fluttify').invokeMethod('cn.jpush.android.service.DownloadProvider::call', {"var1": var1, "var2": var2, "var3": var3 is Ref ? (var3 as Ref)?.refId : var3, "refId": refId});
...
extension cn_jpush_android_service_DownloadProvider_Batch on List<cn_jpush_android_service_DownloadProvider> {
  ...
  Future<List<bool>> onCreate_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/jcore_fluttify').invokeMethod('cn.jpush.android.service.DownloadProvider::onCreate_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
  ...
  Future<List<android_os_Bundle>> call_batch(List<String> var1, List<String> var2, List<android_os_Bundle> var3) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/jcore_fluttify').invokeMethod('cn.jpush.android.service.DownloadProvider::call_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "var2": var2[__i__], "var3": var3[__i__].refId, "refId": this[__i__].refId}]);
