...
class cn_jpush_android_service_AlarmReceiver extends java_lang_Object  {
  ...
  Future<void> onReceive(android_content_Context var1, android_content_Intent var2) async {
    ...
    final __result__ = await MethodChannel('me.yohom/jcore_fluttify').invokeMethod('cn.jpush.android.service.AlarmReceiver::onReceive', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "var2": var2 is Ref ? (var2 as Ref)?.refId : var2, "refId": refId});
...
extension cn_jpush_android_service_AlarmReceiver_Batch on List<cn_jpush_android_service_AlarmReceiver> {
  ...
  Future<List<void>> onReceive_batch(List<android_content_Context> var1, List<android_content_Intent> var2) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/jcore_fluttify').invokeMethod('cn.jpush.android.service.AlarmReceiver::onReceive_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].refId, "var2": var2[__i__].refId, "refId": this[__i__].refId}]);
