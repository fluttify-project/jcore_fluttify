...
import me.yohom.jcore_fluttify.sub_handler.*;
import me.yohom.jcore_fluttify.sub_handler.custom.SubHandlerCustom;
...
public class JcoreFluttifyPlugin implements FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware {

    private static List<Map<String, Handler>> handlerMapList;

    // v1 android embedding for compatible
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "me.yohom/jcore_fluttify", new StandardMethodCodec(new FluttifyMessageCodec()));
    ...
    public void onAttachedToEngine(FlutterPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "JcoreFluttifyPlugin::onAttachedToEngine@" + binding);
        }

        final MethodChannel channel = new MethodChannel(binding.getBinaryMessenger(), "me.yohom/jcore_fluttify", new StandardMethodCodec(new FluttifyMessageCodec()));
    ...
    public void onDetachedFromEngine(FlutterPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "JcoreFluttifyPlugin::onDetachedFromEngine@" + binding);
        }
    }
    ...
    public void onAttachedToActivity(ActivityPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "JcoreFluttifyPlugin::onAttachedToActivity@" + binding);
        }
    ...
    public void onReattachedToActivityForConfigChanges(ActivityPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "JcoreFluttifyPlugin::onReattachedToActivityForConfigChanges@" + binding);
        }
    }
