...
public class JcoreFluttifyPlugin implements MethodChannel.MethodCallHandler {
    ...
    private final Map<String, Handler> handlerMap = new HashMap<String, Handler>() {{
        ...
        // method
        put("cn.jiguang.net.HttpUtils::httpGet__android_content_Context__String__cn_jiguang_net_HttpUtils_HttpListener", (args, methodResult) -> {
            // args
            // ref arg
            android.content.Context var0 = (android.content.Context) getHEAP().get((int) args.get("var0"));
            // jsonable arg
            String var1 = (String) args.get("var1");
            // ref arg
            cn.jiguang.net.HttpUtils.HttpListener var2 = (cn.jiguang.net.HttpUtils.HttpListener) getHEAP().get((int) args.get("var2"));
            ...
            // print log
            if (getEnableLog()) {
                Log.d("fluttify-java", "fluttify-java: cn.jiguang.net.HttpUtils::httpGet(" + var0 + var1 + var2 + ")");
            }
        
            // invoke native method
            try {
                cn.jiguang.net.HttpUtils.httpGet(var0, var1, var2);
            } catch (Throwable throwable) {
                throwable.printStackTrace();
                if (getEnableLog()) {
                    Log.d("Current HEAP: ", getHEAP().toString());
        ...
        // method
        put("cn.jiguang.net.HttpUtils::httpGet__android_content_Context__cn_jiguang_net_HttpRequest__cn_jiguang_net_HttpUtils_HttpListener", (args, methodResult) -> {
            // args
            // ref arg
            android.content.Context var0 = (android.content.Context) getHEAP().get((int) args.get("var0"));
            // ref arg
